  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-salty-cream">
      ...
      >
        ...
        <p className="font-body text-lg text-salty-deep-teal/60 mb-4 leading-relaxed">
          Answer 7 quick questions and we&apos;ll match you with the SALTY retreat
          that fits your vibe, budget, and schedule.
        </p>
        <p className="font-body text-sm text-salty-deep-teal/40 mb-8">
        ...
        <div className="mt-12 flex items-center justify-center gap-8 text-center">
          {[
            ...
            <div key={item.label}>
              <p className="font-display text-2xl text-salty-orange-red">{item.stat}</p>
              <p className="font-body text-xs text-salty-deep-teal/40 uppercase tracking-wide">{item.label}</p>
            </div>
          ))}
        </div>
      </motion.div>
